...
SharedBarOptions.barGroup.args.hideHotkey = ACH:Toggle(L["Hide Keybind Text"], nil, 16, nil, nil, nil, function(info) return E.db.actionbar[info[#info-2]][info[#info]] end, function(info, value) E.db.actionbar[info[#info-2]][info[#info]] = value for _, bar in pairs(AB.handledBars) do AB:UpdateButtonConfig(bar, bar.bindButtons) end end)
...
SharedBarOptions.barGroup.args.countColor = ACH:Color('', nil, 52, nil, nil, function(info) local c = E.db.actionbar[info[#info-2]][info[#info]] local p = P.actionbar[info[#info-2]][info[#info]] return c.r, c.g, c.b, c.a, p.r, p.g, p.b, p.a end, function(info, r, g, b, a) local c = E.db.actionbar[info[#info-2]][info[#info]] c.r, c.g, c.b, c.a = r, g, b, a AB:UpdateButtonSettings() end, nil, function(info) return not E.db.actionbar[info[#info-2]].useCountColor end)
...
SharedBarOptions.barGroup.args.hotkeyColor = ACH:Color('', nil, 57, nil, nil, function(info) local c = E.db.actionbar[info[#info-2]][info[#info]] local p = P.actionbar[info[#info-2]][info[#info]] return c.r, c.g, c.b, c.a, p.r, p.g, p.b, p.a end, function(info, r, g, b, a) local c = E.db.actionbar[info[#info-2]][info[#info]] c.r, c.g, c.b, c.a = r, g, b, a AB:UpdateButtonSettings() end, nil, function(info) return not E.db.actionbar[info[#info-2]].useHotkeyColor end)
...
SharedBarOptions.barGroup.args.macroColor = ACH:Color('', nil, 62, nil, nil, function(info) local c = E.db.actionbar[info[#info-2]][info[#info]] local p = P.actionbar[info[#info-2]][info[#info]] return c.r, c.g, c.b, c.a, p.r, p.g, p.b, p.a end, function(info, r, g, b, a) local c = E.db.actionbar[info[#info-2]][info[#info]] c.r, c.g, c.b, c.a = r, g, b, a AB:UpdateButtonSettings() end, nil, function(info) return not E.db.actionbar[info[#info-2]].useMacroColor end)
